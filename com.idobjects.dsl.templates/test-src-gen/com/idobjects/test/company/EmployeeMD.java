...
public final class EmployeeMD extends IdObjectMD{
    ...
    public static final IdObjectReferenceMD DEPARTMENT = new IdObjectReferenceMD( EmployeeMD.class, DepartmentMD.class, "department", "null", false, ReferenceType.SINGLE, null );
