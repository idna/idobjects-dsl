    ...
    public static final IdObjectPropertyMD AGE = new IdObjectPropertyMD("age", int.class);
	  ...
	  public static final IdObjectReferenceMD DEPARTMENT = new IdObjectReferenceMD( EmployeeMD.class, DepartmentMD.class, "department", "null",false , ReferenceType.SINGLE,
            null );
